...
public class AsteroidsGame extends AbstractAnimation implements KeyListener {
    ...
    /**
     * Checks all Asteroids for collisions with
     * Ship or shot objects and updates variables accordingly.
     */
    protected void checkAsteroids() {
     ...
     * respawn without colliding immediately with another asteroid.
     */
     ...
     * @return copy of Asteroids list
     */
    protected List<Asteroid> getAsteroids() {
        List<Asteroid> temp = new ArrayList<>(asteroids);
        return temp;
    }
    
    /**
     * For testing purposes only.
     * @param asteroids updated list
     */
    protected void setAsteroids(List<Asteroid> asteroids) {
        this.asteroids = asteroids;
    }
    
    /**
     * For testing purposes only.
     * @return copy of gameLevel value
     */
    protected float getLevel() {
        float temp = gameLevel;
        return temp;
    }
    
    /**
     * For testing purposes only.
     * @return canRespawn value
     */
    protected boolean getCanRespawn() {
        boolean temp = canRespawn;
        return temp;
    }
    
    /**
     * For testing purposes only.
     * @param e boolean value to change canRespawn to
     */
    protected void setCanRespawn(boolean e) {
        canRespawn = e;
    }
     ...
     */
    protected boolean getIsDestroyed() {
        boolean temp = isDestroyed;
        return temp;
    }
    
    /**
     * For testing purposes only.
     * @param e boolean value to change isDestroyed to
     */
    protected void setIsDestroyed(boolean e) {
        isDestroyed = e;
    }
    ...
    protected boolean getShooting() {
        boolean temp = shooting;
        return temp;
    }
    
    /**
     * For testing purposes only.
     * @param e boolean value to change shooting to
     */
    protected void setShooting(boolean e) {
        shooting = e;
    }
